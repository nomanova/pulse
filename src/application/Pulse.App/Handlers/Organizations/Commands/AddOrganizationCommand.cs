...
public sealed record AddOrganizationCommand : ICommand<ErrorOr<IdentityDto>>
{
    public required string? OrganizationName { get; init; }
}

public sealed class AddOrganizationCommandAuthorizer : PermissionAuthorizer<AddOrganizationCommand>;

public class AddOrganizationCommandHandler : ICommandHandler<AddOrganizationCommand, ErrorOr<IdentityDto>>
{
    ...
    public async Task<ErrorOr<IdentityDto>> Handle(AddOrganizationCommand command,
