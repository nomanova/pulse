...
public sealed class EnvListCommand : PagedEnvCommand
{
    ...
    private void Print(List<EnvironmentDto> entities, Config config, string? lastId)
    {
        var table = new Table();
        ...
        {
            var isSelected = config.Context.Environment?.Name == entity.Name;
