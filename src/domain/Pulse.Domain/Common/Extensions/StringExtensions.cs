...
namespace Pulse.Domain.Common.Extensions;
...
public static partial class StringExtensions
{
    ...
    /**
     * Converts a string to a normalized version appropriate for querying, which improves
     * the search experience for users as they don't have to type exact case and punctuations.
     *
     ...
     * - Lowercased
     */
    public static string AsNormalizedQueryable(this string? input)
    {
    ...
    private static string FoldToAscii(this string input, int? length = null)
    {
